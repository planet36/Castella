...
- [ ] **Gotchas to hunt for and demand documentation of:**
  ...
  - **KAT files are frozen** (`1204a8d4…` tree KAT "must never change") — is the contract that
    a digest change is a breaking change stated where a contributor will see it?
