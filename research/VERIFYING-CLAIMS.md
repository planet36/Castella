...
| 4 | Trail bounds: A = 45 active S-boxes at r = 2 (solved); A ≥ 128 at r = 3 (solver dual bound); A ≥ 137/173 at r = 4/5 (superadditivity) | executable (solver) + arithmetic | §4 |
...
A bit-based division-property model (a matching **lower** bound on degree / a tight integral analysis, complementing §15's upper bound and covering the inside-out zero-sum precisely); trail tightness at r = 2 (the §13 minimization times out, leaving a bracket rather than a minimum); and, at r ≥ 3, a **solved** active-S-box bound — the MILP has never closed its duality gap at N = 16 above r = 2.  At r = 3 the remaining gap is one active S-box (dual bound 127.554 after 90 min, incumbent 129), so A(3) is 128 or 129; at r = 4 and r = 5 the floors are superadditive rather than solved and correspondingly loose (A(4) ≥ 137 against a pattern known to exist at 165).  r = 5 additionally has no ceiling: probes timed out in stage A at both 30 and 55 min without producing an activity pattern to instantiate, and r ≥ 6 has not been attempted.  Whether more time closes r = 3 is unresolved: the dual bound climbed steadily to 126.6 by 55 min and then advanced only 0.9 in the next 35, so the endgame is far slower than the approach.  At r = 4 the picture is different and now measured: 90 minutes reaches a dual bound of only 93.9 against an incumbent of 165, a 76% gap against r = 3's 1%, and weaker than the 137 superadditivity gives for free — so at that round count the solver contributes nothing and no amount of `-t` is likely to.  Planned in [CRYPTO-SECURITY-CLAIMS-PLAN.md](../CRYPTO-SECURITY-CLAIMS-PLAN.md) § 5, no conclusive results yet.  (Slide analysis moved to §10, the affine-self-similarity screen; rebound to §14, a margin argument; the algebraic-degree upper bound to §15.)  Until a row moves out of this section, the corresponding gap is disclosed in SPEC.md's Evidence section ("necessary, not sufficient").
