...
| 3 | 9 | **129** (solved; was ~~133~~) | 2<sup>−774</sup> | 2<sup>−841</sup> | [774, 841] |
| 4 | 12 | **165** (solved; was ~~225~~) | 2<sup>−990</sup> | 2<sup>−1151</sup> | [990, 1151] |
| 5 | 15 | **234** (solved; was ~~243~~) | 2<sup>−1404</sup> | 2<sup>−1633</sup> | [1404, 1633] — from an imported MILP pattern; stage A still finds none |
| 6 | 18 | **270** (solved; was ~~290~~) | 2<sup>−1620</sup> | 2<sup>−1887</sup> | [1620, 1887] — imported pattern, as at _r_ = 5 |
| 7 | 21 | **354** (solved) | 2<sup>−2124</sup> | 2<sup>−2473</sup> | [2124, 2473] — imported pattern, as at _r_ = 5 |
| 8 | 24 | **390** (solved) | 2<sup>−2340</sup> | 2<sup>−2725</sup> | [2340, 2725] — imported pattern, as at _r_ = 5 |

Every round count now has both ends, and every floor is **solved**, so the remaining width is entirely the trail search's: 385 bits at _r_ = 8, 349 at _r_ = 7, 267 at _r_ = 6, 229 at _r_ = 5, 161 at _r_ = 4, 67 at _r_ = 3, 24 at _r_ = 2.  The width grows smoothly with _r_ rather than jumping where the import takes over, which is mild evidence that the imported-pattern ceilings are no worse in kind than the searched ones.  The _r_ = 4 figure used to read 325 against a superadditive floor of 828 — solving _A_(4) = 165 raised that floor to 990 and halved the apparent gap, which is what a loose floor costs when it is mistaken for the trail's slack.  Every floor is far past 2<sup>−256</sup>.
...
# The recorded ceilings at r = 3 and r = 4 (841 and 1151) come from sweeping BOTH the
# pattern count and the seed: run each K as its own process, in parallel, and take the
# lightest.  The r >= 5 ceilings are seed sweeps only -- --patterns has nothing to
# enumerate when the single pattern comes from a file.
...
# Seeds vary the trail: nine gave 1633-1638, seed 5 winning with 1633.
