...
# r = 2: witness finds the low-weight trails (~4 min each); minimization then times out
python3 permute-trail-search.py -r 2 --patterns 1 -t 3600 --encoding witness --print-trail

# r = 3: same, one round further (~25 min to the first trail, then the timeout)
python3 permute-trail-search.py -r 3 --patterns 1 -t 3600 --encoding witness --print-trail
```
